...
'use strict';
var CONFIG={
  order:{title:'สั่งงาน Graphic',subtitle:'สร้าง มอบหมาย และติดตามสถานะงานของทีม',icon:'clipboard',host:function(p){return p.firstElementChild||p;}},
  links:{title:'รวมลิงก์ Content',subtitle:'จัดการสคริปต์ ลิงก์คลิป และข้อมูล Content ในที่เดียว',icon:'link',host:function(p){return p.querySelector('.ct-wrap')||p;}},
  ...
  fblist:{title:'จัดการ Facebook Pages',subtitle:'ดูสถานะเพจ อัปเดตข้อมูล และเพิ่มรายการใหม่',icon:'facebook',host:function(p){return p;}},
