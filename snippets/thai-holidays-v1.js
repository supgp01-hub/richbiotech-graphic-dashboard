(function () {
  ...
  function shell(body) {
    var existing=document.getElementById('lv-holiday-controls'),bar=document.getElementById('lvw-calendar-toolbar');
    if(existing){if(bar&&existing.parentNode!==bar)bar.appendChild(existing);return;}
