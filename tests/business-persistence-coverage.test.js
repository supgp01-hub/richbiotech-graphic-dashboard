...
assert.ok(index.includes('snippets/persistence-reliability-v3.js?v=fix'),'ทุกโมดูลต้องใช้คิวออนไลน์ที่ลองใหม่ได้');
assert.ok(index.includes('snippets/order-durable-queue-v1.js?v=fix'),'คิวงานต้องมีพื้นที่สำรองถาวรเมื่อ localStorage เต็ม');
...
assert.ok(index.includes('snippets/shared-business-sync-v1.js?v=fix'),'ข้อมูลธุรกิจรุ่นเดิมต้องใช้ชั้นซิงก์กลาง');
