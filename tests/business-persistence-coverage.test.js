...
assert.ok(index.includes('snippets/persistence-reliability-v3.js?v=fix354'),'ทุกโมดูลต้องใช้คิวออนไลน์ที่ลองใหม่ได้');
...
assert.ok(index.includes('snippets/shared-business-sync-v1.js?v=fix354'),'ข้อมูลธุรกิจรุ่นเดิมต้องใช้ชั้นซิงก์กลาง');
