...
assert.ok(index.includes('<meta name="rb-build" content="fix366">'),'build marker must expose the current release');
...
assert.ok(index.includes('snippets/order-planner-v1.js?v=fix366'),'planner script must be loaded');
