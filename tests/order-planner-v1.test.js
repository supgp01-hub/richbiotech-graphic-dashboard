...
assert.ok(index.includes('<meta name="rb-build" content="fix368">'),'build marker must expose the current release');
...
assert.ok(index.includes('snippets/order-planner-v1.js?v=fix368'),'planner script must be loaded');
