...
assert.ok(html.includes('leave-workforce-v1.css?v=fix329'));
assert.ok(html.includes('leave-workforce-v1.js?v=fix329'));
...
assert.ok(source.includes("var VERSION='2.7.0'"));
...
assert.ok(source.includes('รายการล่าสุดของฉัน'));
