...
assert.ok(html.includes('commission-center-v1.css?v=fix309'),'commission stylesheet must be loaded');
assert.ok(html.includes('commission-center-v1.js?v=fix309'),'commission runtime must be loaded');
...
assert.ok(js.includes('ระบบกันข้อมูลซ้ำด้วย พนักงาน + วันที่ + สินค้า'),'duplicate protection must be visible');
