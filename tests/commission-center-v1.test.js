...
assert.ok(html.includes('commission-center-v1.css?v=fix'),'commission stylesheet must be loaded');
assert.ok(html.includes('commission-center-v1.js?v=fix'),'commission runtime must be loaded');
