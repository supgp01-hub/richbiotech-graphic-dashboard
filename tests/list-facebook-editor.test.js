...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix288-send-image-ver-layout">'), 'the deployed page must expose its current build for cache diagnosis');
