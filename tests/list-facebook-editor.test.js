...
assert.ok(indexSource.includes('list-facebook-followup.css?v=270'), 'the deployed page must load the follow-up workspace layout');
assert.ok(indexSource.includes("list-facebook-followup.js?v=271"), 'the deployed page must load the follow-up workflow');
assert.ok(indexSource.includes('<meta name="rb-build" content="fix271">'), 'the deployed page must expose its current build for cache diagnosis');
