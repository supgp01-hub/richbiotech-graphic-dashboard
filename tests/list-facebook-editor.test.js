...
assert.ok(indexSource.includes("list-facebook-followup.js?v=fix398"), 'the deployed page must load the follow-up workflow');
assert.ok(indexSource.includes('<meta name="rb-build" content="fix398">'), 'the deployed page must expose its current build for cache diagnosis');
