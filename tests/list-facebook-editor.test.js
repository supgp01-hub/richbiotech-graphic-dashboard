...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix286-audit-job-version-isolation">'), 'the deployed page must expose its current build for cache diagnosis');
