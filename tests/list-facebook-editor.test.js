...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix294-planner-single-entry">'), 'the deployed page must expose its current build for cache diagnosis');
