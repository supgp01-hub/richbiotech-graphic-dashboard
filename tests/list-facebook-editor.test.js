...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix280-order-image-submit-links">'), 'the deployed page must expose its current build for cache diagnosis');
