...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix289-remove-duplicate-image-links">'), 'the deployed page must expose its current build for cache diagnosis');
