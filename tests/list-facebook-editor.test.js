...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix303-planner-history-hooks">'), 'the deployed page must expose its current build for cache diagnosis');
