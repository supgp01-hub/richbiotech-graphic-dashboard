...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix296-facebook-status-sync">'), 'the deployed page must expose its current build for cache diagnosis');
