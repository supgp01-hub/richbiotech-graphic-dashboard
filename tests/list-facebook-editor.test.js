...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix297-planner-dropdown-link-sync">'), 'the deployed page must expose its current build for cache diagnosis');
