...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix290-sync-image-delivery-links">'), 'the deployed page must expose its current build for cache diagnosis');
