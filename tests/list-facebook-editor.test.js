...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix281-order-detail-edit">'), 'the deployed page must expose its current build for cache diagnosis');
