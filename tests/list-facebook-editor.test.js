...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix302-stable-public-url">'), 'the deployed page must expose its current build for cache diagnosis');
