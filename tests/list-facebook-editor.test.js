...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix291-preserve-brief-line-breaks">'), 'the deployed page must expose its current build for cache diagnosis');
