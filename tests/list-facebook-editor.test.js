...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix299-facebook-pages-inline-editor">'), 'the deployed page must expose its current build for cache diagnosis');
