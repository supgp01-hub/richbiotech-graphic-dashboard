...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix292-optional-delivery-evidence">'), 'the deployed page must expose its current build for cache diagnosis');
