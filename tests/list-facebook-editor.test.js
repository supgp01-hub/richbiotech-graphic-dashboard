...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix284-audit-status-runtime">'), 'the deployed page must expose its current build for cache diagnosis');
