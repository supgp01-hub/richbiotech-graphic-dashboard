...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix300-leave-persistence">'), 'the deployed page must expose its current build for cache diagnosis');
