...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix298-planner-dropdown-layer">'), 'the deployed page must expose its current build for cache diagnosis');
