...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix282-audit-version-workflow">'), 'the deployed page must expose its current build for cache diagnosis');
