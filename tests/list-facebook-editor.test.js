...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix301-planner-status-filters">'), 'the deployed page must expose its current build for cache diagnosis');
