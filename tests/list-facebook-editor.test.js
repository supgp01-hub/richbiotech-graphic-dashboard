...
assert.ok(indexSource.includes('<meta name="rb-build" content="fix295-planner-new-order-parity">'), 'the deployed page must expose its current build for cache diagnosis');
