...
assert(source.includes("if(_omIsNew&&state&&state.online){clearOMDraft();_omIsNew=false;_omEditingKey=entry._fbKey;_omReservedId='';}"), 'only a confirmed online new-order save may clear its draft and reservation');
