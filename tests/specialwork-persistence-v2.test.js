...
(async()=>{
  ...
  assert.equal(document.documentElement['data-specialwork-persistence'],'2.0.0');
  ...
  vm.runInNewContext(source,{window:offlineWindow,document:offlineDocument,localStorage:offlineStorage,Promise,Date,JSON,Object,Array,String,Number,Math,console});
  ...
  assert.ok(index.includes('snippets/specialwork-persistence-v2.js?v=fix319'));
