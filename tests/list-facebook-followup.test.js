...
assert.ok(/event\.stopImmediatePropagation\(\);\s+openFollowupModal\(nameButton\.getAttribute\('data-key'\)\)/.test(source), 'clicking an account name must open only the follow-up popup and suppress the legacy account popup');
