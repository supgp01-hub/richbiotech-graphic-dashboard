...
assert.ok(index.includes('snippets/bulk-import-v2.js?v=fix'), 'content cloud cache must be refreshed');
assert.ok(index.includes('snippets/performance-v4.js?v=fix'), 'content sync cache must be refreshed');
