...
assert.ok(index.includes('snippets/bulk-import-v2.js?v=208'), 'content cloud cache must be refreshed');
assert.ok(index.includes('snippets/performance-v4.js?v=fix336'), 'content sync cache must be refreshed');
