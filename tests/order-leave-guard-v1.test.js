...
assert.ok(index.includes('<meta name="rb-build" content="fix278-list-facebook-credentials-drawer">'),'deployed page must expose build fix278-list-facebook-credentials-drawer');
