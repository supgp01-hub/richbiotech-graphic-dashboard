...
assert.ok(index.includes('<meta name="rb-build" content="fix279-list-facebook-full-credentials">'),'deployed page must expose build fix279-list-facebook-full-credentials');
