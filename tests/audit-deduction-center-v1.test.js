...
assert.ok(index.includes('audit-sheet-evidence-v1.js?v=fix471')&&js.includes('window.rbAuditSheetEvidence.read(force)'),'audit import must read the real spreadsheet hyperlink metadata');
