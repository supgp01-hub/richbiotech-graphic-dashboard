...
assert.ok(index.includes('order-audit-version-workflow-v1.css?v=fix'),'the unified version layout must be cache-busted');
assert.ok(index.includes('order-audit-version-workflow-v1.js?v=fix'),'the unified version runtime must be cache-busted');
