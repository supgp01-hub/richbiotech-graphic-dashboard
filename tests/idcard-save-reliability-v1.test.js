...
assert(html.includes('snippets/idcard-save-reliability-v1.js?v=fix373'),'reliability runtime must be loaded');
assert(html.includes('snippets/idcard-save-reliability-v1.css?v=fix373'),'reliability styles must be loaded');
